...
public class ExpenseManager {
    ...
    public void addExpenseInteractive() {
        ...
        double spent = budget.getSpent(cat);
        if (lim>0 && spent>lim) System.out.println(ConsoleColors.yellow("WARNING: overspent "+cat));
        else if (lim>0 && spent>=0.8*lim) System.out.println(ConsoleColors.yellow("Near limit: "+cat));
    }
    ...
    /*public void showExpenses() {
        Utils.input(""); // small pause
        System.out.println(ConsoleColors.blue("\n--- Expenses ---"));
        if (expenses.isEmpty()) { System.out.println(ConsoleColors.BRIGHT_BLACK+"No expenses yet."+ConsoleColors.RESET); return; }
        for (Expense e: expenses) System.out.println(e);
    }*/

public void showExpenses() {
    // small pause removed — use Utils.pause() if desired
    System.out.println(ConsoleColors.blue("\n--- Expenses ---"));
    if (expenses.isEmpty()) {
        System.out.println(ConsoleColors.blue("No expenses yet."));
        return;
    }
    for (Expense e: expenses) System.out.println(e);
}
